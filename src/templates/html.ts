            ...
            <section class="upload-section">
                ...
                <div class="form-group">
                    <label class="form-label" for="promptInput">
                        <span style="color: var(--accent-color); margin-right: 0.5rem;">✏️</span>
    ...
    <div id="loginModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-muted" data-i18n="login_required_message">您需要登录后才能使用文档生成服务</p>
                <div id="loginContent" style="margin-top: 1rem;">
...
function getInlineJS(): string {
  return `
    <script>
      // 内联国际化配置
      const I18N_CONFIG = ${JSON.stringify(i18nConfig)};
...
<head>
    ...
    <meta name="description" content="AI智能体文档生成平台，支持PPT、PDF、Word、Excel等格式生成">
    <meta name="keywords" content="AI,文档生成,PPT,PDF,Word,Excel,智能体">
    ${getInlineCSS()}
</head>
<body>
    ${getHTMLContent()}
